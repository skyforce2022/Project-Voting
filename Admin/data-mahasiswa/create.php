      ...
      <div class="col-md-10 p-1 pt-3 text-secondary">
             ...
             <form action="" method="post">
                 <div class="mb-3">    
                     ...
                     <input type="text" name="id_mahasiswa" id="id_mahasiswa" required class="form-control" placeholder="Masukkan id mahasiswa">
                 </div>
                 <div class="mb-3">    
                     <label for="TextInput" class="form-label text-dark">Nama Mahasiswa</label>
                     <input type="text" name="nama_kandidat" id="nama_kandidat" class="form-control" placeholder="Masukkan nama mahasiswa">
                    </div>
                    <div class="mb-3">    
