...
<body>
    ...
    <div class="col-md-10 p-5 pt-2"><br>
      <h3><i class="fa-solid fa-users"></i> DATA MAHASISWA </h3><br>
      
      <a href="create.php" class="btn btn-primary mb-3"><i class="fas fa-user-plus mr-3"></i> INPUT DATA MAHASISWA</a>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
              <tr>   
                  ...
                  <td><a href="detail.php" class="btn btn-primary">Detail</a></td>
              <td><a href="update.php"><i class="fas fa-edit bg-success p-2 text-white rounded" data-toggle="tooltip" title="Edit"></i></a></td>
